...
class ParallelGatewayModel extends RectNodeModel {
    setAttributes() {
    }
...
class ParallelGatewayView extends RectNode {
    // 重写父类的方法
    getLabelShape() {
...
// 导出自定义节点
export default {
    name: '并行网关', // 必填：拖拽面板上的组件展示名称
    icon: 'parallel-gateway', // 必填：拖拽面板上的组件图标，和 assets/icons/svgs 文件名保持一致
    type: bpmnNodeType.parallelGateway, // 节点类型
