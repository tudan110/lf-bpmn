...
class TimerIntermediateCatchEventModel extends RectNodeModel {
    getNodeStyle() {
...
class TimerIntermediateCatchEventView extends RectNode {
    // 重写父类的方法
    getLabelShape() {
...
// 导出自定义节点
export default {
    name: '定时中间捕获事件', // 必填：拖拽面板上的组件展示名称
    icon: 'timer-intermediate-catch-event', // 必填：拖拽面板上的组件图标，和 assets/icons/svgs 文件名保持一致
    type: bpmnNodeType.intermediateCatchEvent, // 节点类型
    view: TimerIntermediateCatchEventView,
    model: TimerIntermediateCatchEventModel
}
